...
function BaseFacebook(config) {
  ...
  if (Object.prototype.hasOwnProperty.call(config, 'currentUrl')) {
    this.currentUrl = config.currentUrl;
  }
  this.setAppId(config.appId);
  this.setAppSecret(config.secret);
  if (Object.prototype.hasOwnProperty.call(config, 'fileUpload')) {
...
BaseFacebook.prototype.getRequestParam = function(key) {
  ...
  if (this.request.query && this.request.Object.prototype.hasOwnProperty.call(query, key)) {
    return this.request.query[key];
  }
  else if (this.request.body && this.request.Object.prototype.hasOwnProperty.call(body, key)) {
...
BaseFacebook.prototype.hasCookie = function(key) {
  return this.request && this.request.cookies && this.request.Object.prototype.hasOwnProperty.call(cookies, key);
};
...
BaseFacebook.prototype.getUserAccessToken = function getUserAccessToken(callback) {
  ...
  if (signedRequest) {
    ...
    if (Object.prototype.hasOwnProperty.call(signedRequest, 'oauth_token')) {
      ...
      if (Object.prototype.hasOwnProperty.call(signedRequest, 'code')) {
...
BaseFacebook.prototype.getLoginUrl = function(params) {
  ...
  var scopeParams = Object.prototype.hasOwnProperty.call(params, 'scope') ? params.scope : null;
...
BaseFacebook.prototype.getUserFromAvailableData = function getUserFromAvailableData(callback) {
  ...
  var signedRequest = this.getSignedRequest();
  if (signedRequest) {
    if (Object.prototype.hasOwnProperty.call(signedRequest, 'user_id')) {
...
BaseFacebook.prototype.restserver = function restserver(params, callback) {
  ...
  this.oauthRequest(host, '/restserver.php', params, cb.returnToCallback(callback, false, function(response) {
    ...
    if (result && typeof result === 'object' && Object.prototype.hasOwnProperty.call(result, 'error_code')) {
    ...
    if (this.hasCookie(cookieName)) {
      ...
      if (this.response) {
        if (!this.sentHeaders()) {
          ...
          if (Object.prototype.hasOwnProperty.call(metadata, 'base_domain') && typeof metadata['base_domain'] === 'string' && metadata['base_domain'] !== '') {
...
BaseFacebook.prototype.getApiHost = function(method) {
  ...
  if (this.Object.prototype.hasOwnProperty.call(apiReadOnlyCalls, method.toLowerCase())) {
    ...
    cb.returnToCallback(callback, true, function(err, accessTokenResponse) {
      if (err) {
        ...
        if (!accessTokenResponse) {
          ...
          if (!Object.prototype.hasOwnProperty.call(responseParams, 'access_token')) {
            return false;
          }
          else {
...
BaseFacebook.prototype.shouldRetainParam = function(param) {
  ...
  return !((splited.length > 1) && this.Object.prototype.hasOwnProperty.call(dropQueryParams, splited[0]));
};
...
function FacebookApiError(result) {
  ...
  this.code = this.Object.prototype.hasOwnProperty.call(result, 'error_code') ? result.error_code : 0;

  if (Object.prototype.hasOwnProperty.call(result, 'error_description')) {
    // OAuth 2.0 Draft 10 style
    var msg = result.error_description;
  } else if (Object.prototype.hasOwnProperty.call(result, 'error') && result.error && typeof (result.error) === 'object') {
    // OAuth 2.0 Draft 00 style
    var msg = result.error.message;
  } else if (Object.prototype.hasOwnProperty.call(result, 'error_msg')) {
    // Rest server style
...
FacebookApiError.prototype.getType = function() {
  if (this.Object.prototype.hasOwnProperty.call(result, 'error')) {
