...
BaseFacebook.prototype.getApiHost = function(method) {
  ...
  if (Object.prototype.hasOwnProperty.call(this.apiReadOnlyCalls, method.toLowerCase())) {
...
BaseFacebook.prototype.shouldRetainParam = function(param) {
  ...
  return !((splited.length > 1) && Object.prototype.hasOwnProperty.call(this.dropQueryParams, splited[0]));
};
...
function FacebookApiError(result) {
  ...
  this.code = Object.prototype.hasOwnProperty.call(this.result, 'error_code') ? result.error_code : 0;
...
FacebookApiError.prototype.getType = function() {
  if (Object.prototype.hasOwnProperty.call(this.result, 'error')) {
